...
class _Tracker(object):
    def __init__(self):
        ...
        self._previous_cost_min = None
        self._previous_cost_params = None
    ...
    def _update_tracker(self, event, instance):
        if event == Events.OPTIMIZATION_STEP:
            ...
            # 更新 cost_min 
            current_min = instance.cost_min
            if (self._previous_cost_min is None
                    or current_min["cost"] < self._previous_cost_min):
                self._previous_cost_min = current_min["cost"]
                self._previous_cost_params = current_min["params"]
